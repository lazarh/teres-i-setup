...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-l", "4", NULL };
/* static const char *termcmd[]  = { "st",  NULL }; */
static const char *termcmd[] = {"tabbed", "-c", "-r", "2", "st", "-w", "''", NULL};
static const char *firefox[] = { "firefox", NULL };
static const char *mpc[] = { "mpc", "toggle", NULL };
